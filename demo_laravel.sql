/*
 ...
 Source Schema         : demo_laravel

 Target Server Type    : MySQL
 Target Server Version : 50723
 File Encoding         : 65001

 Date: 15/10/2018 16:15:29
*/
...
CREATE TABLE `oc_address`  (
  ...
  `address_1` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `address_2` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `oc_api_ip`  (
  ...
  PRIMARY KEY (`api_ip_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_api_session`  (
  ...
  `date_added` datetime(0) NOT NULL,
  `date_modified` datetime(0) NOT NULL,
  PRIMARY KEY (`api_session_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_attribute_description`  (
  ...
  PRIMARY KEY (`attribute_id`, `language_id`) USING BTREE
...
CREATE TABLE `oc_attribute_group_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`attribute_group_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_cart`  (
  ...
  `option` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `quantity` int(5) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`cart_id`) USING BTREE,
  INDEX `cart_id`(`api_id`, `customer_id`, `session_id`, `product_id`, `recurring_id`) USING BTREE
...
CREATE TABLE `oc_category_filter`  (
  ...
  PRIMARY KEY (`category_id`, `filter_id`) USING BTREE
...
CREATE TABLE `oc_country`  (
  ...
  `address_format` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `postcode_required` tinyint(1) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`country_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 258 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_coupon`  (
  ...
  `uses_customer` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  `date_added` datetime(0) NOT NULL,
...
CREATE TABLE `oc_custom_field`  (
  ...
  `validation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `oc_custom_field_customer_group`  (
  ...
  PRIMARY KEY (`custom_field_id`, `customer_group_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_custom_field_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`custom_field_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_custom_field_value`  (
  ...
  `custom_field_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`custom_field_value_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_custom_field_value_description`  (
  ...
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`custom_field_value_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer`  (
  ...
  `wishlist` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `oc_customer_activity`  (
  ...
  `ip` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_activity_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer_affiliate`  (
  ...
  `tax` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `payment` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cheque` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `paypal` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bank_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bank_branch_number` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bank_swift_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bank_account_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bank_account_number` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `custom_field` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_id`) USING BTREE
...
CREATE TABLE `oc_customer_approval`  (
  ...
  `customer_id` int(11) NOT NULL,
  `type` varchar(9) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_approval_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer_group_description`  (
  ...
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`customer_group_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer_reward`  (
  ...
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_reward_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer_search`  (
  ...
  `ip` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_search_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_customer_transaction`  (
  ...
  `amount` decimal(15, 4) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`customer_transaction_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_download`  (
  ...
  `filename` varchar(160) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `mask` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
...
CREATE TABLE `oc_download_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`download_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_extension_install`  (
  ...
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`extension_install_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_extension_path`  (
  ...
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`extension_path_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_filter_description`  (
  ...
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`filter_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_filter_group`  (
  ...
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`filter_group_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_filter_group_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`filter_group_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_geo_zone`  (
  ...
  `date_added` datetime(0) NOT NULL,
  `date_modified` datetime(0) NOT NULL,
  PRIMARY KEY (`geo_zone_id`) USING BTREE
...
CREATE TABLE `oc_information_to_layout`  (
  ...
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`, `store_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_layout_module`  (
  ...
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`layout_module_id`) USING BTREE
...
CREATE TABLE `oc_layout_route`  (
  ...
  PRIMARY KEY (`layout_route_id`) USING BTREE
...
CREATE TABLE `oc_length_class_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `title` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `unit` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`length_class_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_location`  (
  ...
  `telephone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fax` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `geocode` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `open` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `comment` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `oc_manufacturer_to_store`  (
  ...
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`, `store_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_modification`  (
  ...
  `link` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `xml` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  `date_added` datetime(0) NOT NULL,
...
CREATE TABLE `oc_order_recurring`  (
  ...
  `recurring_id` int(11) NOT NULL,
  `recurring_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `recurring_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `recurring_frequency` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `recurring_cycle` smallint(6) NOT NULL,
  `recurring_duration` smallint(6) NOT NULL,
  `recurring_price` decimal(10, 4) NOT NULL,
  `trial` tinyint(1) NOT NULL,
  `trial_frequency` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `trial_cycle` smallint(6) NOT NULL,
  `trial_duration` smallint(6) NOT NULL,
  `trial_price` decimal(10, 4) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`order_recurring_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_order_recurring_transaction`  (
  ...
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`order_recurring_transaction_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_order_shipment`  (
  ...
  `order_id` int(11) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  `shipping_courier_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `oc_order_voucher`  (
  ...
  `from_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `from_email` varchar(96) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `to_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `to_email` varchar(96) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `voucher_theme_id` int(11) NOT NULL,
  `message` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `amount` decimal(15, 4) NOT NULL,
  PRIMARY KEY (`order_voucher_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_product`  (
  ...
  `upc` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ean` varchar(14) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `jan` varchar(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `isbn` varchar(17) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `mpn` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `oc_product` VALUES (49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'catalog/demo/samsung_tab_1.jpg', 0, 1, 199.9900, 0, 9, '2011-04-25', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2011-09-30 01:06:23');
...
CREATE TABLE `oc_product_description`  (
  ...
  `meta_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `meta_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`product_id`, `language_id`) USING BTREE,
  INDEX `name`(`name`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_product_filter`  (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`, `filter_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_product_image`  (
  ...
  INDEX `product_id`(`product_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2352 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 227 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_product_recurring`  (
  ...
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`, `recurring_id`, `customer_group_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
) ENGINE = MyISAM AUTO_INCREMENT = 546 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_product_special`  (
  ...
  `date_start` date NOT NULL,
  `date_end` date NOT NULL,
  PRIMARY KEY (`product_special_id`) USING BTREE,
  INDEX `product_id`(`product_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 440 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_product_to_download`  (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`, `download_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_recurring`  (
  ...
  `frequency` enum('day','week','semi_month','month','year') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `duration` int(10) UNSIGNED NOT NULL,
  `cycle` int(10) UNSIGNED NOT NULL,
  `trial_status` tinyint(4) NOT NULL,
  `trial_price` decimal(10, 4) NOT NULL,
  `trial_frequency` enum('day','week','semi_month','month','year') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `trial_duration` int(10) UNSIGNED NOT NULL,
  `trial_cycle` int(10) UNSIGNED NOT NULL,
  `status` tinyint(4) NOT NULL,
  `sort_order` int(11) NOT NULL,
  PRIMARY KEY (`recurring_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_recurring_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`recurring_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_return_action`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`return_action_id`, `language_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_return_history`  (
  ...
  `comment` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`return_history_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_return_reason`  (
  ...
  `language_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`return_reason_id`, `language_id`) USING BTREE
...
CREATE TABLE `oc_return_status`  (
  ...
  `language_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`return_status_id`, `language_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_seo_url`  (
  ...
  `keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`seo_url_id`) USING BTREE,
  INDEX `query`(`query`) USING BTREE,
...
INSERT INTO `oc_setting` VALUES (43, 0, 'config', 'config_api_id', '1', 0);
...
INSERT INTO `oc_setting` VALUES (66, 0, 'config', 'config_email', 'demo@opencart.com', 0);
...
INSERT INTO `oc_setting` VALUES (77, 0, 'config', 'config_encryption', '', 0);
...
CREATE TABLE `oc_shipping_courier`  (
  ...
  `shipping_courier_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `shipping_courier_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`shipping_courier_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_tax_rate_to_customer_group`  (
  ...
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`, `customer_group_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_tax_rule`  (
  ...
  `tax_class_id` int(11) NOT NULL,
  `tax_rate_id` int(11) NOT NULL,
  `based` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `priority` int(5) NOT NULL DEFAULT 1,
  PRIMARY KEY (`tax_rule_id`) USING BTREE
...
CREATE TABLE `oc_theme`  (
  ...
  `route` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `code` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_added` datetime(0) NOT NULL,
...
CREATE TABLE `oc_voucher_history`  (
  ...
  `amount` decimal(15, 4) NOT NULL,
  `date_added` datetime(0) NOT NULL,
  PRIMARY KEY (`voucher_history_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `oc_voucher_theme`  (
  ...
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`voucher_theme_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_voucher_theme_description`  (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`voucher_theme_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_weight_class_description`  (
  ...
  `title` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `unit` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`weight_class_id`, `language_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 4239 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `oc_zone_to_geo_zone`  (
  ...
  `date_added` datetime(0) NOT NULL,
  `date_modified` datetime(0) NOT NULL,
  PRIMARY KEY (`zone_to_geo_zone_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 110 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'nguyen', 'hien@gmail.com', '$2y$10$32KGXsEsmG2qwNSdGtCY4.54Z6d2X5GBCsIf7j76ohJnROoICHKhm', '1SwCyOaVqZbHvP1PZRQZIS9UnuavvPBMAU0zsKSLdrLSfEvlcGup5KOsBiva', '2018-10-15 07:18:38', '2018-10-15 07:18:38');
INSERT INTO `users` VALUES (2, 'dsad', 'votinh123@gmail.com', '$2y$10$ePduBTt/R6PrFZ2u799ef.z7wyuwMvpPnvTqfvzqds1fZxRjXSX6i', 'dfPC5EPLXxUeRm9pUf4TTt39wczxnuPJDMoeCPWfcOUZcjMCKeSbLZe4KIKJ', '2018-10-15 07:56:03', '2018-10-15 07:56:03');
